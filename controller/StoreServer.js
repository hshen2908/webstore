...
var StoreServer = /** @class */ (function (_super) {
    __extends(StoreServer, _super);
    function StoreServer() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    StoreServer.prototype.initServer = function () {
        var _this = this;
        // auth router attaches /login, /logout, and /callback routes to the baseURL
        this.app.use((0, express_openid_connect_1.auth)(auth0Config));
        ...
        this.app.get('/profile', (0, express_openid_connect_1.requiresAuth)(), function (req, res) {
            res.send(JSON.stringify(req.oidc.user));
        });
        this.registerRouter("/", Root_1.rootRouter);
        this.registerRouter("/admin", Admin_1.adminRouter);
    };
    return StoreServer;
}(Server_1.Server));
